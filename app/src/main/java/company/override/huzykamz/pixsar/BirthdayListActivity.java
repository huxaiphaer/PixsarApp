...
public class BirthdayListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Birthday Events");
...
//        mAuth = FirebaseAuth.getInstance();
        ...
        queryRef = mDatabase.orderByChild("EventType").equalTo("Birthday Party");
   ...
   Load();
    ...
    void Load(){
        FirebaseRecyclerAdapter<Event,BirthdayViewHolder> firebaseRecyclerAdapter_ = new FirebaseRecyclerAdapter<Event, BirthdayListActivity.BirthdayViewHolder>(Event.class,
                R.layout.item_event_view,
                BirthdayListActivity.BirthdayViewHolder.class,
                queryRef) {
            @Override
            protected void populateViewHolder(BirthdayListActivity.BirthdayViewHolder viewHolder, final Event model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent loadMainActivity = new Intent(BirthdayListActivity.this,BlogScrolling.class);
              ...
              //  viewHolder.setEventDate(model.getEventDate());
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent loadMainActivity = new Intent(BirthdayListActivity.this,BlogActivity.class);
                        loadMainActivity.putExtra("PARTY_NAME", model.getEventName());
                        startActivity(loadMainActivity);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (newText.length() > 3) {
                    ...
                    FirebaseRecyclerAdapter<Event,BirthdayListActivity.BirthdayViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Event, BirthdayListActivity.BirthdayViewHolder>
                            (Event.class,
                                    R.layout.item_event_view,
                                    BirthdayListActivity.BirthdayViewHolder.class,
                                    queryRef_) {
                        @Override
                        protected void populateViewHolder(BirthdayListActivity.BirthdayViewHolder viewHolder, final Event model, int position) {
                            Bitmap b = null;
                            viewHolder.setEventLocation(model.getEventLocation());
                            viewHolder.setEventName(model.getEventName());
                            viewHolder.setEventType(model.getEventType());
