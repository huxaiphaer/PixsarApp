...
public class IntroductionListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Introduction Parties");
...
//        mAuth = FirebaseAuth.getInstance();
        ...
        queryRef = mDatabase.orderByChild("EventType").equalTo("Introduction Party");
    ...
    void Load(){
        FirebaseRecyclerAdapter<Event,EventViewHolder> firebaseRecyclerAdapter_ = new FirebaseRecyclerAdapter<Event, IntroductionListActivity.EventViewHolder>(Event.class,
                R.layout.item_event_view,
                IntroductionListActivity.EventViewHolder.class,
                queryRef) {
            @Override
            protected void populateViewHolder(IntroductionListActivity.EventViewHolder viewHolder, final Event model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent loadMainActivity = new Intent(IntroductionListActivity.this,BlogScrolling.class);
        ...
        FirebaseRecyclerAdapter<Event,EventViewHolder> firebaseRecyclerAdapter_ = new FirebaseRecyclerAdapter<Event, IntroductionListActivity.EventViewHolder>(Event.class,
            ...
            protected void populateViewHolder(IntroductionListActivity.EventViewHolder viewHolder, final Event model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // Toast.makeText(EventViewActivity.this,"This is : "+position,Toast.LENGTH_LONG).show();
                        Intent loadMainActivity = new Intent(IntroductionListActivity.this,BlogActivity.class);
                        loadMainActivity.putExtra("PARTY_NAME", model.getEventName());
                        startActivity(loadMainActivity);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (newText.length() > 2) {
                    ...
                    FirebaseRecyclerAdapter<Event,IntroductionListActivity.EventViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Event, IntroductionListActivity.EventViewHolder>
                            (Event.class,
                                    R.layout.item_event_view,
                                    IntroductionListActivity.EventViewHolder.class,
                                    queryRef_) {
                        @Override
                        protected void populateViewHolder(IntroductionListActivity.EventViewHolder viewHolder, final Event model, int position) {
